...
class MainController extends CI_Controller {
    ...
    public function outgoing() {
        ...
        // $config['base_url'] = site_url().'/outgoing';
        ...
        $data['project_name'] = $this->project_name;
        $data['title'] = $this->project_name.' | WP Outgoing';
        $data['content_view'] = 'views/pages/outgoing.php';
        $data['vue'] = 'outgoing.js';
